...
# MIT License - Copyright (c) 2016 Adafruit Industries
...
class SSD1306:
    ...
    def invert(self, invert):
        """Invert display (1 to invert, 0 for normal)"""
        self.write_cmd(SET_NORM_INV | (invert & 1))
    
    def show(self):
        """Write the framebuffer to display memory"""
        x0 = 0
        x1 = self.width - 1
        if self.width == 64:
...
class SSD1306_SPI(SSD1306):
    """SPI interface for SSD1306 display"""
